...
namespace FlowerShop.Areas.Admin.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public MenusController(QlbhtContext context)
        {
            _context = context;
        }
        ...
        {
            var qlbhtContext = _context.Menus.Include(m => m.Parent);
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuName,Description,ParentId,SortOrder,IsActive,Alias,Levels")] Menu menu)
        {
            ...
            {
                menu.Alias = FlowerShop.Utilities.Function.TitleSlugGenerationAlias(menu.MenuName);
                _context.Add(menu);
